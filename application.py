...
st.markdown(
    ...
    .rule-part { color:#9eb1c1; font-size:.75rem; line-height:1.45; margin-top:.24rem; }
    .rule-part b { color:#d9e6ef; }
...
st.markdown(
    ...
    <div class="rule-grid">
      ...
      <div class="rule-card"><div class="rule-no">02 · CANDLE TWO</div><div class="rule-title">Two-part price condition</div><div class="rule-part"><b>Part A:</b> Candle 2 low &lt; Candle 1 low</div><div class="rule-part"><b>Part B:</b> Candle 2 high &lt; Candle 1 high</div><div class="rule-text" style="margin-top:.35rem">Candle colour does not matter.</div></div>
...
if st.button("RUN LATEST NIFTY 200 SCAN  →", type="primary", use_container_width=True):
    try:
        ...
        if result.empty:
            ...
            display_result = result[["Symbol", "Pattern"]].rename(
                columns={"Symbol": "Stock Name", "Pattern": "Setup"}
            )
            st.dataframe(
                display_result,
